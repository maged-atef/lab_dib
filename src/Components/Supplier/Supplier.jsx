...
export default function Supplier() {
    return <div className="flex flex-col w-full mx-auto ">
        <div className="bg-white px-2 py-3" id="addNew">
            <p className="font-semibold capitalize rounded-xl  md:text-2xl border-b border-slate-200">add new supplier</p>

            <div className="  border-slate-400 rounded-xl bg-white/80 my-3 px-4 py-1">

                <div className="grp">

                    <input type="text" name="" id="userid" placeholder="enter supplier" className="bg-blue-50 p-2 rounded m-2 w-full outline-none focus:ring-2 focus:ring-blue-500" />


                    <input type="text" name="" id="empID" placeholder="phone" className="bg-blue-50 p-2 rounded m-2 w-full outline-none focus:ring-2 focus:ring-blue-400" />
                    ...
                    <input type="text" name="" id="dateID" placeholder="type" className="bg-blue-50 p-2 rounded m-2 w-full outline-none focus:ring-2 focus:ring-blue-400" />
                ...
                <div className="users ">
                    <p className="font-semibold text-center border-b my-4 border border-slate-400 rounded-b-lg md:text-2xl">Current Registered Supplier</p>
                    <div className="users_indb rounded border px-2 py-3  overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr>
                                    <th className="px-2  text-start">id</th>
                                    <th className="px-2 text-start ">Supplier</th>
                                    <th className="px-2  text-start">email</th>
                                    <th className="px-2  text-start">Phone</th>
